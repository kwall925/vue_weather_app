    ...
    <main>
      ...
      <div class="weather-wrap" v-if="typeof weather.main != 'undefined'">
        ...
        <div style="margin-top: 5px; text-align: center;">
          <p style="font-size: 0.9em; color: white;">Enter the "city, state" e.g. "madison, wisconsin"</p>
        </div>
        </div>
...
export default {
  ...
  data() {
    return {
      api_key: 'dbd84f9a4ba74c591d79a15490c793e3',
...
#app {
  background: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(9,9,121,1) 42%, rgba(0,212,255,1) 76%);
...
#app.warm {
  background: linear-gradient(90deg, rgba(226,0,0,1) 0%, rgba(252,177,11,1) 42%, rgba(255,245,38,1) 76%);
  }
main {
  min-height: 100vh;
  padding: 25px;
